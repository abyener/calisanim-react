...
export default class CalisanProfil extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  componentDidMount() {
    Worker.all().then(data => data.map(wor => {
      if (wor.id == this.state.id) {
        this.setState({
          isValid: true,
          data: wor,
        })
                ...
                <Row>
                  <Col lg="5">
                    ...
                    <div className="profile-section">
                      ...
                      <p><strong>{this.state.data.gender} - {this.state.data.title} - {this.state.data.location}</strong></p>
